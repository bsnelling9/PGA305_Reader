...
def to_signed_24(v):
    """Convert unsigned 24-bit value to signed integer."""
    return v - 0x1000000 if v & 0x800000 else v


def calculate_pressure():
    """
    Reads PADC_GAIN, PADC_OFFSET, and OFF_EN from EEPROM once.
    Then reads PADC and calculates P. User types 'r' to read again, 'q' to quit.
    """
    reader = PGA305Reader()
    ...
    try:
        ...
        def read_and_calculate():
            ...
            padc_raw = to_signed_24((p3 << 16) | (p2 << 8) | p1)
        ...
        # Read once immediately on entry
        print("\n" + "=" * 70)
        read_and_calculate()
        print("\n" + "=" * 70)
