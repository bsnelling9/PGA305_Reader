...
def test_output():
    ...
    try:
        ...
        print("\nMode: (1) manual output test (2) Passive DAC read")
        ...
        if enter_command:
            ...
            reader.write_register(0x39, 0x00, config.I2C_CONTROL)  # DAC_RATIOMETRIC=0
            reader.write_register(0x67, 0x00, config.I2C_CONTROL)  # AMUX_CTRL
